...
public class NoticeServiceImpl implements NoticeService {
	...
	public NoticeDTO getNotice(HttpServletRequest request) {
		int notice_no = 0;
	    String notice_no_param = request.getParameter("notice_no");
	    if (notice_no_param != null) {
	        notice_no = Integer.parseInt(notice_no_param);
	    }
	...
	public int modifyNotice(HttpServletRequest request) {
	    ...
	    String title = request.getParameter("title");
	    String content = request.getParameter("content");
	    NoticeDTO noticeDTO = new NoticeDTO(notice_no, gubun, title, content);
	...
	public int removeNotice(HttpServletRequest request) {
		int notice_no = 0;
	    String notice_no_str = request.getParameter("notice_no");
	    if (notice_no_str != null) {
	        notice_no = Integer.parseInt(notice_no_str);
	    }
